...
const translations = {
  English: {
    ...
    q_jit_village: '📍 By the way, which village or town is your farm located in?\nThis will help us tailor future daily check-ins and expert advisories for your area.',
    msg_jit_village_success: '✅ Thank you! I\'ve updated your farm location to *{village}*. 🚀',
  ...
  Telugu: {
    ...
    q_jit_village: '📍 ఒక చిన్న విషయం, మీ ఫారం ఏ గ్రామం లేదా పట్టణంలో ఉంది?\nఇది మీ ప్రాంతానికి తగిన రోజువారీ సూచనలు మరియు నిపుణుల సలహాలను అందించడానికి మాకు సహాయపడుతుంది.',
    msg_jit_village_success: '✅ ధన్యవాదాలు! మీ ఫారమ్ స్థానాన్ని *{village}* కు అప్‌డేట్ చేసాను. 🚀',
  ...
  Hindi: {
    ...
    q_jit_village: '📍 वैसे, आपका फार्म किस गाँव या शहर में स्थित है?\nयह हमें आपके क्षेत्र के लिए दैनिक चेक-इन और विशेषज्ञ सलाह को अनुकूलित करने में मदद करेगा।',
    msg_jit_village_success: '✅ धन्यवाद! मैंने आपके फ़ार्म का स्थान *{village}* पर अपडेट कर दिया है। 🚀',
